...
# Define symbol lists
SYMBOL_LISTS = {
    "LIST1": ["1INCHUSDT","A8","Aave","ACA","ACE","ACH","ACT","ACX","ADA","AERGO","AGLD","AI16Z","AIN","AITECH","AIXBT","ALCH","ALGO","AI","ALICE","ALPH","ALPINE","ALT","ALU","AMP","ANKR","ANLOG","ANYONE","APE","API3","APT"
