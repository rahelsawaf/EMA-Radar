...
# Define symbol lists
SYMBOL_LISTS = {
    "LIST1": [" 1INCHUSDT", " A8USDT"," AaveUSDT", " ACAUSDT", " ACEUSDT"
  ," ACHUSDT", " ACTUSDT", " ACXUSDT"," ADAUSDT"," AERGOUSDT"
  , " AGLDUSDT", " AI16ZUSDT"," AINUSDT"," AITECHUSDT"," AIXBTUSDT"
  ," ALCHUSDT"," ALGOUSDT", " AIUSDT", " ALICEUSDT", " ALPHUSDT"
  ," ALPINEUSDT", " ALTUSDT", " ALUUSDT", " AMPUSDT"," ANKRUSDT"
  , " ANLOGUSDT", " ANYONEUSDT", " APEUSDT", " API3USDT"," APTUSDT"
  , " ARBUSDT"," ARCUSDT", " ARKMUSDT", " ARKUSDT", " ARPAUSDT"
  ," ASIUSDT"," ASTOUSDT", " ARUSDT", " ASTRUSDT"," ATHUSDT"
  , " ATOMUSDT", " AURORAUSDT", " AVAAIUSDT"," AVAILUSDT", " AVAUSDT"
  , " AVAXUSDT"," AXLUSDT", " AZEROUSDT", " BADUSDT", " BAIUSDT", " BANANAUSDT", " BANDUSDT", " BATUSDT", " BEAMUSDT"," BGBUSDT"
  , " BGSCUSDT"," BICOUSDT", " BIOUSDT"," BLURUSDT", " BLZUSDT"
  , " BMTUSDT"," BRNUSDT"," BSVUSDT", " BTTUSDT", " CARVUSDT"
  , " CELOUSDT", " CELRUSDT", " CFXUSDT", " CHRUSDT", " CHZUSDT"
  , " CKBUSDT", " CLOREUSDT", " COOKIEUSDT", " COREUMUSDT", " COREUSDT"
  , " CREOUSDT", " CROSUSDT", " CSPRUSDT", " CTSIUSDT", " CVCUSDT"
  , " CYBERUSDT", " DEGENUSDT", " DENTUSDT", " DMAILUSDT", " DOTUSDT"
  , " DTECUSDT", " DUSDT", " DUSKUSDT", " EGLDUSDT", " ELAUSDT"
  , " ELFUSDT", " ENJUSDT", " ENSUSDT", " EOSUSDT", " EPTUSDT"
  , " ETCUSDT", " ETHWUSDT", " FETUSDT", " FHEUSDT", " FIDAUSDT", " FILUSDT", " FITFIUSDT", " FLOWUSDT", " FLUXUSDT", " FTNUSDT"
  , " FUELUSDT", " GALAUSDT", " GASUSDT", " GFALUSDT", " GHXUSDT"
  , " GLMRUSDT", " GLMUSDT", " GMTUSDT", " GOMININGUSDT", " GPSUSDT"
  , " GRASSUSDT", " GRTUSDT", " GTCUSDT", " HBARUSDT", " HEIUSDT"
  , " HIGHUSDT", " HIVEUSDT", " HNTUSDT", " HOOKUSDT"," HOTUSDT"
  , " HYPERUSDT", " IAGUSDT", " ICEUSDT", " ICPUSDT", " ICXUSDT"
  , " IDUSDT", " IMXUSDT", " IOTXUSDT", " IPUSDT", " IQUSDT"
  , " JASMYUSDT", " KAIAUSDT", " KAITOUSDT", " KASUSDT", " KDAUSDT"
  , " KLAYUSDT", " KSMUSDT", " L3USDT", " LATUSDT", " LINKUSDT"
  , " LNQUSDT", " LOOKSUSDT"," LPTUSDT", " LRCUSDT", " LSKUSDT"],  # List 1: BTC, LIT

    
    "LIST2": [" LUNAUSDT", " LYXUSDT", " MAGICUSDT", " MANAUSDT", " MANTAUSDT"
  , " MASAUSDT", " MASKUSDT", " MDTUSDT", " MERLUSDT", " METISUSDT"
  , " MEUSDT", " MINAUSDT", " MOBILEUSDT", " MOCAUSDT", " MOVEUSDT"
  , " MOVRUSDT", " MTLUSDT", " MVLUSDT", " MYRIAUSDT", " NCUSDT"
  , " NEARUSDT", " NEXAUSDT", " NFPUSDT", " NFTUSDT", " NILUSDT"
  , " NKNUSDT", " NMTUSDT", " NSUSDT", " NTRNUSDT", " NYMUSDT"
  , " OASUSDT", " OGNUSDT", " OMGUSDT", " OMUSDT", " ONEUSDT"
  , " ONGUSDT", " OORTUSDT", " OPUSDT", " ORAIUSDT", " ORBSUSDT"
  , " ORDIUSDT", " OXTUSDT", " PARTIUSDT", " PEAQUSDT", " PHAUSDT"
  , " PHBUSDT", " PLUMEUSDT", " POLUSDT", " POLYXUSDT", " PONDUSDT"

  , " PORTALUSDT", " POWRUSDT", " PRIMEUSDT", " PROMPTUSDT", " PROMUSDT"
  , " PROPCUSDT", " PROPSUSDT", " PYTHUSDT", " PYUSDUSDT", " QKCUSDT"
  , " QNTUSDT", " QTUMUSDT", " QUBICUSDT", " RADUSDT", " RAREUSDT"
  , " RDNTUSDT", " RIFUSDT"," RLCUSDT", " ROAMUSDT", " ROOTUSDT"
  , " ROSEUSDT"," RSRUSDT", " RSS3USDT"," SAFEUSDT", " SAGAUSDT"
  , " SANDUSDT", " SCRUSDT", " SEIUSDT", " SFPUSDT", " SHELLUSDT"
  , " SIGNUSDT", " SKLUSDT", " SLFUSDT", " SNTUSDT", " SONICUSDT"
  ," STMXUSDT"," STORJUSDT", " STPTUSDT", " STRAXUSDT", " STXUSDT"
  , " SUIUSDT", " SWARMSUSDT", " SWEATUSDT", " SXPUSDT", " SYSUSDT"
  , " TAIKOUSDT", " TAOUSDT", " TELUSDT", " TETUSDT", " TIAUSDT"
  
  , " TLOSUSDT", " TNSRUSDT", " TONUSDT", " TRBUSDT", " TRIASUSDT"
  , " TWTUSDT", " U2UUSDT", " UMAUSDT", " UROUSDT", " UXLINKUSDT"
  , " VAIUSDT", " VANAUSDT", " VANRYUSDT", " VETUSDT", " VICUSDT"
  , " VIRTUALUSDT", " VRUSDT", " VTHOUSDT", " WALUSDT", " WAVESUSDT"
  , " WAXPUSDT", " WCTUSDT", " WELLUSDT", " WILDUSDT", " WLDUSDT"
  , " WSDMUSDT", " WUSDT", " XAIUSDT"," XCNUSDT", " XDCUSDT"
  , " XEMUSDT", " XIONUSDT", " XLMUSDT", " XPRUSDT", " XRDUSDT"
  , " XRPUSDT", " XTERUSDT", " XTZUSDT"," ZBCNUSDT", " ZBUUSDT"
  , " ZENUSDT", " ZETAUSDT", " ZIGUSDT", " ZILUSDT", " ZKJUSDT"
  , " ZKUSDT", " ZRCUSDT", " ZROUSDT", " ZZZUSDT" ]   # List 2: BTC, ETH
}
